...
import Alogo from "../images/[removal.ai]_d3979850-097f-4455-9573-66f06220c49f-107.png"
          ...
          <div className="navbar-menu-wrapper d-flex align-items-top"> 
            <ul className="navbar-nav">
              <li className="nav-item font-weight-semibold d-none d-lg-block ms-0">
                ...
                <h3 className="welcome-sub-text">Performance of your Aplha Store this week </h3>
              </li>
            </ul>
