                          ...
                          <div className="col-sm-12">
                            <div className="statistics-details d-flex align-items-center justify-content-between">
                              <div>
                                ...
                                <h3 className="rate-percentage">4</h3>
                                <p className="text-success d-flex"><i className="mdi mdi-menu-up" /><span>-0.5%</span></p>
                              </div>
                              <div>
                                <p className="statistics-title">Total Orders</p>
                                <h3 className="rate-percentage">10</h3>
                                <p className="text-success d-flex"><i className="mdi mdi-menu-down" /><span>+0.1%</span></p>
                              </div>
                              <div>
                                <p className="statistics-title">Total Sale</p>
                                <h3 className="rate-percentage">2253</h3>
                                <p className="text-danger d-flex"><i className="mdi mdi-menu-down" /><span>68.8</span></p>
                              </div>
                              <div className="d-none d-md-block">
                                <p className="statistics-title">Order Shipped</p>
                                <h3 className="rate-percentage">8</h3>
                                <p className="text-success d-flex"><i className="mdi mdi-menu-down" /><span>+0.8%</span></p>
                              </div>
                              <div className="d-none d-md-block">
                                <p className="statistics-title">Total Users</p>
                                <h3 className="rate-percentage">1</h3>
                                <p className="text-danger d-flex"><i className="mdi mdi-menu-down" /><span>68.8</span></p>
                              </div>
                              <div className="d-none d-md-block">
                                <p className="statistics-title">Orders Pending</p>
